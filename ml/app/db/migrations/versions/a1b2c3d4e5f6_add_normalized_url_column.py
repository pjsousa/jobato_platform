"""Add normalized_url column to run_items for dedupe keys
...
def upgrade() -> None:
    ...
    op.add_column("run_items", sa.Column("normalization_error", sa.String(), nullable=True))
    # Index for fast dedupe lookups by normalized_url
...
def downgrade() -> None:
    ...
    op.drop_column("run_items", "normalization_error")
